...
def day4() -> None:
    with open("inputs/2023/day4.txt", encoding="utf-8") as file:
    ...
    for line in lines:
        ...
        cards.append(
            Card(
                card_id, list(map(int, winning_numbers.split())), list(map(int, my_numbers.split()))
            )
        )
    ...
    # part 2
    card_instances: dict[Card, int] = dict.fromkeys(cards, 1)
