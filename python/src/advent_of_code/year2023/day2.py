...
class Game:
    ...
    def from_string(string: str) -> Game:
        ...
        sets: list[Set] = [Set.from_string(played_set) for played_set in played_sets.split("; ")]
    ...
    def is_possible(self, played_set: Set) -> bool:
        for game_set in self.sets:
            if (
                played_set.red < game_set.red
                or played_set.green < game_set.green
...
def day2() -> None:
    with open("inputs/2023/day2.txt", encoding="utf-8") as file:
