def parse_forest(
    x_coord: int, y_coord: int, forest: list[list[int]]
...
def advent8() -> None:
    with open("inputs/2022/day8.txt", encoding="utf-8") as file:
        lines = file.readlines()

    forest: list[list[int]] = [[int(char) for char in line.strip()] for line in lines]
